...
- **Currently open-source**:
  ...
  - Boilerplate Next.js + Medusa: **[apps/store](https://github.com/lomiafrica/store/)**
...
- **Opening Soon**:
  - API service: **[apps/api](https://github.com/lomiafrica/lomi./)**
  - Shopify extension: **[apps/shopify](https://github.com/lomiafrica/shopify/)**
  - CLI tool: **[apps/cli](https://github.com/lomiafrica/lomi./)**
...
We welcome contributions to improve lomi. and its features. If you find any issues or have suggestions, please open an issue or submit a pull request on our [GitHub repository](https://github.com/lomiafrica/dashboard).
...
- **GitHub**: Submit [issues](https://github.com/lomiafrica/dashboard/issues) for bug reports and feature requests
