...
- **Webhook Secret (`LOMI_WEBHOOK_SECRET`)**: Your webhook signing secret from the **lomi. Merchant Portal**. Stored in `.env` for your _application_ to verify incoming webhook signatures.
