...
- **One API, one dashboard**: One integration for all your payment needs, allowing you to accept credit card payments, MTN 'Momo', Wave Mobile Money, Orange Money, and more (we are continuously expanding our set of integrations to help you reach an ever-growing set of consumers in Africa and beyond).
...
> **_Get started touching West Africa today by [creating an account](https://lomi.africa/sign-up)._**
...
- SDKs in popular languages (cURL, JavaScript, Python, PHP and GoLang).
...
- Shopify extension to help you accept payments in your Shopify store and get paid faster.
