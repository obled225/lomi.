...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/subscriptions?page=1&pageSize=20" \
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/subscriptions/customer/cus_abc123..." \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/subscriptions/sub_abc123..." \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X POST "https://api.lomi.africa/v1/subscriptions/sub_abc123.../cancel" \
  -H "X-API-KEY: $LOMI_API_KEY" \
