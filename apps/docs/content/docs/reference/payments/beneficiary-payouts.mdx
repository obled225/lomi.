...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/beneficiary-payouts?statuses=completed&currencyCode=XOF&limit=20" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/beneficiary-payouts/bp_abc123..." \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
