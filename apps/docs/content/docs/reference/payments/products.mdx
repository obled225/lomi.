...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/products?isActive=true&limit=20" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/products/prod_abc123..." \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X POST "https://api.lomi.africa/v1/products/prod_abc123.../prices" \
  -H "X-API-KEY: $LOMI_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "amount": 50000,
...
<Tab value="cURL">
```bash
curl -X POST "https://api.lomi.africa/v1/products/prod_abc123.../prices/price_def456.../set-default" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
