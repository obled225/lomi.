...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/refunds?status=completed&startDate=2024-01-01T00:00:00Z&limit=20" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/refunds/ref_abc123..." \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
