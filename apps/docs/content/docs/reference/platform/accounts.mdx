...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/accounts" \
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/accounts/acc_abc123..." \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
```bash
# All currencies
curl -X GET "https://api.lomi.africa/v1/accounts/balance" \
  -H "X-API-KEY: $LOMI_API_KEY"

# Specific currency
curl -X GET "https://api.lomi.africa/v1/accounts/balance?currency=XOF" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/accounts/balance/breakdown?target_currency=USD" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/accounts/balance/check/XOF" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
