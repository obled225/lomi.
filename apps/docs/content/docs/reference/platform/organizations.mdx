...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/organizations" \
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/organizations/org_abc123..." \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
...
<Tab value="cURL">
```bash
curl -X GET "https://api.lomi.africa/v1/organizations/metrics" \
  -H "X-API-KEY: $LOMI_API_KEY"
```
</Tab>
