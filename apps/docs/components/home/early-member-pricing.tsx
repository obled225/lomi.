  ...
  return (
    <div className="lg:mb-38 md:mt-20 hidden md:block">
      <div className="max-w-7xl mx-auto pl-2 pr-4 py-2">
        ...
        <section className="overflow-hidden relative bg-transparent text-foreground dark:text-foreground rounded-sm border p-0 pb-16 pt-16 md:pb-32 md:pt-32 before:absolute before:inset-0 before:bg-linear-to-r before:from-foreground/5 before:via-transparent before:to-foreground/5 before:pointer-events-none dark:before:from-background/20 dark:before:to-background/20 select-none">
