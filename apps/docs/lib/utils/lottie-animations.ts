...
import dialpadAnimation from '@/app/assets/lottie/dialpad.json';
...
import helpQuestionAnimation from '@/app/assets/lottie/help-question.json';
import bankAnimation from '@/app/assets/lottie/bank.json';
import assignmentAnimation from '@/app/assets/lottie/assignment.json';
...
export const animations = {
  ...
  helpQuestion: helpQuestionAnimation,
  bank: bankAnimation,
  assignment: assignmentAnimation,
};
