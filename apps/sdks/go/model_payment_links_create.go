...
func (o PaymentLinksCreate) MarshalJSON() ([]byte, error) {
...
func (o PaymentLinksCreate) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentLinksCreate struct {
	value *PaymentLinksCreate
	isSet bool
}

func (v NullablePaymentLinksCreate) Get() *PaymentLinksCreate {
	return v.value
}

func (v *NullablePaymentLinksCreate) Set(val *PaymentLinksCreate) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentLinksCreate) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentLinksCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentLinksCreate(val *PaymentLinksCreate) *NullablePaymentLinksCreate {
	return &NullablePaymentLinksCreate{value: val, isSet: true}
}

func (v NullablePaymentLinksCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentLinksCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
