...
// CheckoutSessionsCreate Request body for creating a checkout sessions object. System-managed fields like `created_at`, `organization_id`, and IDs are automatically set.
