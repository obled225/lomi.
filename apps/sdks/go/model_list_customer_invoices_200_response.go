...
// checks if the ListCustomerInvoices200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListCustomerInvoices200Response{}

// ListCustomerInvoices200Response struct for ListCustomerInvoices200Response
type ListCustomerInvoices200Response struct {
...
func NewListCustomerInvoices200Response() *ListCustomerInvoices200Response {
	this := ListCustomerInvoices200Response{}
	return &this
}
...
func (o ListCustomerInvoices200Response) MarshalJSON() ([]byte, error) {
...
func (o ListCustomerInvoices200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListCustomerInvoices200Response struct {
	value *ListCustomerInvoices200Response
	isSet bool
}

func (v NullableListCustomerInvoices200Response) Get() *ListCustomerInvoices200Response {
	return v.value
}

func (v *NullableListCustomerInvoices200Response) Set(val *ListCustomerInvoices200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListCustomerInvoices200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListCustomerInvoices200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCustomerInvoices200Response(val *ListCustomerInvoices200Response) *NullableListCustomerInvoices200Response {
	return &NullableListCustomerInvoices200Response{value: val, isSet: true}
}

func (v NullableListCustomerInvoices200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCustomerInvoices200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
