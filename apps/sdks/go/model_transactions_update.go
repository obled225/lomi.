...
// checks if the TransactionsUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionsUpdate{}

// TransactionsUpdate Request body for updating a transactions object. Only include fields you want to modify.
...
func (o TransactionsUpdate) MarshalJSON() ([]byte, error) {
...
func (o TransactionsUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionsUpdate struct {
	value *TransactionsUpdate
	isSet bool
}

func (v NullableTransactionsUpdate) Get() *TransactionsUpdate {
	return v.value
}

func (v *NullableTransactionsUpdate) Set(val *TransactionsUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionsUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionsUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionsUpdate(val *TransactionsUpdate) *NullableTransactionsUpdate {
	return &NullableTransactionsUpdate{value: val, isSet: true}
}

func (v NullableTransactionsUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionsUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
