...
// checks if the ListInstallmentPayments200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListInstallmentPayments200Response{}

// ListInstallmentPayments200Response struct for ListInstallmentPayments200Response
type ListInstallmentPayments200Response struct {
...
func NewListInstallmentPayments200Response() *ListInstallmentPayments200Response {
	this := ListInstallmentPayments200Response{}
	return &this
}
...
func (o ListInstallmentPayments200Response) MarshalJSON() ([]byte, error) {
...
func (o ListInstallmentPayments200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListInstallmentPayments200Response struct {
	value *ListInstallmentPayments200Response
	isSet bool
}

func (v NullableListInstallmentPayments200Response) Get() *ListInstallmentPayments200Response {
	return v.value
}

func (v *NullableListInstallmentPayments200Response) Set(val *ListInstallmentPayments200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInstallmentPayments200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInstallmentPayments200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInstallmentPayments200Response(val *ListInstallmentPayments200Response) *NullableListInstallmentPayments200Response {
	return &NullableListInstallmentPayments200Response{value: val, isSet: true}
}

func (v NullableListInstallmentPayments200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInstallmentPayments200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
