...
type ApiRetrieveEventRequest struct {
	ctx context.Context
	ApiService *EventsAPIService
	eventId string
}

func (r ApiRetrieveEventRequest) Execute() (*Events, *http.Response, error) {
	return r.ApiService.RetrieveEventExecute(r)
}
...
Retrieve a specific event by its unique identifier.
 ...
 @return ApiRetrieveEventRequest
*/
func (a *EventsAPIService) RetrieveEvent(ctx context.Context, eventId string) ApiRetrieveEventRequest {
	return ApiRetrieveEventRequest{
		ApiService: a,
		ctx: ctx,
		eventId: eventId,
...
// Execute executes the request
//  @return Events
func (a *EventsAPIService) RetrieveEventExecute(r ApiRetrieveEventRequest) (*Events, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventsAPIService.RetrieveEvent")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
