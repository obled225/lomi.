...
func (o ProductsCreate) MarshalJSON() ([]byte, error) {
...
func (o ProductsCreate) ToMap() (map[string]interface{}, error) {
...
type NullableProductsCreate struct {
	value *ProductsCreate
	isSet bool
}

func (v NullableProductsCreate) Get() *ProductsCreate {
	return v.value
}

func (v *NullableProductsCreate) Set(val *ProductsCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableProductsCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableProductsCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductsCreate(val *ProductsCreate) *NullableProductsCreate {
	return &NullableProductsCreate{value: val, isSet: true}
}

func (v NullableProductsCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductsCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
