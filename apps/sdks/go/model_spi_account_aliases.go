...
func (o SpiAccountAliases) MarshalJSON() ([]byte, error) {
...
func (o SpiAccountAliases) ToMap() (map[string]interface{}, error) {
...
type NullableSpiAccountAliases struct {
	value *SpiAccountAliases
	isSet bool
}

func (v NullableSpiAccountAliases) Get() *SpiAccountAliases {
	return v.value
}

func (v *NullableSpiAccountAliases) Set(val *SpiAccountAliases) {
	v.value = val
	v.isSet = true
}

func (v NullableSpiAccountAliases) IsSet() bool {
	return v.isSet
}

func (v *NullableSpiAccountAliases) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpiAccountAliases(val *SpiAccountAliases) *NullableSpiAccountAliases {
	return &NullableSpiAccountAliases{value: val, isSet: true}
}

func (v NullableSpiAccountAliases) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpiAccountAliases) UnmarshalJSON(src []byte) error {
	v.isSet = true
