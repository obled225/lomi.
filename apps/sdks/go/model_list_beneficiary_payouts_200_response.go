...
// checks if the ListBeneficiaryPayouts200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListBeneficiaryPayouts200Response{}

// ListBeneficiaryPayouts200Response struct for ListBeneficiaryPayouts200Response
type ListBeneficiaryPayouts200Response struct {
...
func NewListBeneficiaryPayouts200Response() *ListBeneficiaryPayouts200Response {
	this := ListBeneficiaryPayouts200Response{}
	return &this
}
...
func (o ListBeneficiaryPayouts200Response) MarshalJSON() ([]byte, error) {
...
func (o ListBeneficiaryPayouts200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListBeneficiaryPayouts200Response struct {
	value *ListBeneficiaryPayouts200Response
	isSet bool
}

func (v NullableListBeneficiaryPayouts200Response) Get() *ListBeneficiaryPayouts200Response {
	return v.value
}

func (v *NullableListBeneficiaryPayouts200Response) Set(val *ListBeneficiaryPayouts200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListBeneficiaryPayouts200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListBeneficiaryPayouts200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListBeneficiaryPayouts200Response(val *ListBeneficiaryPayouts200Response) *NullableListBeneficiaryPayouts200Response {
	return &NullableListBeneficiaryPayouts200Response{value: val, isSet: true}
}

func (v NullableListBeneficiaryPayouts200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListBeneficiaryPayouts200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
