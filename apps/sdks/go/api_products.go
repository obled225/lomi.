...
*/
func (a *ProductsAPIService) CreatePrice(ctx context.Context) ApiCreatePriceRequest {
	return ApiCreatePriceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Prices
func (a *ProductsAPIService) CreatePriceExecute(r ApiCreatePriceRequest) (*Prices, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductsAPIService.CreatePrice")
	if err != nil {
...
*/
func (a *ProductsAPIService) DeletePrice(ctx context.Context, priceId string) ApiDeletePriceRequest {
	return ApiDeletePriceRequest{
		ApiService: a,
		ctx: ctx,
		priceId: priceId,
...
// Execute executes the request
func (a *ProductsAPIService) DeletePriceExecute(r ApiDeletePriceRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductsAPIService.DeletePrice")
	if err != nil {
...
*/
func (a *ProductsAPIService) ListPrices(ctx context.Context) ApiListPricesRequest {
	return ApiListPricesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ProductsAPIService) ListPricesExecute(r ApiListPricesRequest) (*ListPrices200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductsAPIService.ListPrices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ProductsAPIService) RetrievePrice(ctx context.Context, priceId string) ApiRetrievePriceRequest {
	return ApiRetrievePriceRequest{
		ApiService: a,
		ctx: ctx,
		priceId: priceId,
...
// Execute executes the request
//  @return Prices
func (a *ProductsAPIService) RetrievePriceExecute(r ApiRetrievePriceRequest) (*Prices, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductsAPIService.RetrievePrice")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ProductsAPIService) UpdatePrice(ctx context.Context, priceId string) ApiUpdatePriceRequest {
	return ApiUpdatePriceRequest{
		ApiService: a,
		ctx: ctx,
		priceId: priceId,
...
// Execute executes the request
//  @return Prices
func (a *ProductsAPIService) UpdatePriceExecute(r ApiUpdatePriceRequest) (*Prices, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductsAPIService.UpdatePrice")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
