...
class ProductsApi
{
     ...
     * Create price
     *
     * @param  \LomiLaravel\Model\PricesCreate $prices_create prices_create (required)
     ...
     * @return \LomiLaravel\Model\Prices|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * Create price
     *
     * @param  \LomiLaravel\Model\PricesCreate $prices_create (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrice'] to see the possible values for this operation
     *
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\Prices|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\LomiLaravel\Model\Prices';
        $request = $this->createPriceRequest($prices_create, $contentType);
     ...
     * Create product
     *
     * @param  \LomiLaravel\Model\ProductsCreate $products_create products_create (required)
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\Products|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * Create product
     *
     * @param  \LomiLaravel\Model\ProductsCreate $products_create (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createProduct'] to see the possible values for this operation
     *
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\Products|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\LomiLaravel\Model\Products';
        $request = $this->createProductRequest($products_create, $contentType);
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\ListPrices200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\ListPrices200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listPricesWithHttpInfo($limit = 20, $offset = 0, $sort = null, string $contentType = self::contentTypes['listPrices'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\LomiLaravel\Model\ListPrices200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\LomiLaravel\Model\ListPrices200Response';
        $request = $this->listPricesRequest($limit, $offset, $sort, $contentType);
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\ListProducts200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\ListProducts200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listProductsWithHttpInfo($limit = 20, $offset = 0, $sort = null, string $contentType = self::contentTypes['listProducts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\LomiLaravel\Model\ListProducts200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\LomiLaravel\Model\ListProducts200Response';
        $request = $this->listProductsRequest($limit, $offset, $sort, $contentType);
     ...
     *
     * @param  string $price_id Unique identifier for the price (required)
     * @param  \LomiLaravel\Model\PricesUpdate $prices_update prices_update (required)
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\Prices|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     *
     * @param  string $price_id Unique identifier for the price (required)
     * @param  \LomiLaravel\Model\PricesUpdate $prices_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updatePrice'] to see the possible values for this operation
     *
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\Prices|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $product_id Unique identifier for the product (required)
     * @param  \LomiLaravel\Model\ProductsUpdate $products_update products_update (required)
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\Products|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     *
     * @param  string $product_id Unique identifier for the product (required)
     * @param  \LomiLaravel\Model\ProductsUpdate $products_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateProduct'] to see the possible values for this operation
     *
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\Products|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
