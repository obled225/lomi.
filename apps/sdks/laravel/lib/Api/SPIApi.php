...
class SPIApi
{
     ...
     * Create spi qr code
     *
     * @param  \LomiLaravel\Model\SpiQrCodesCreate $spi_qr_codes_create spi_qr_codes_create (required)
     ...
     * @return \LomiLaravel\Model\SpiQrCodes|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * Create spi qr code
     *
     * @param  \LomiLaravel\Model\SpiQrCodesCreate $spi_qr_codes_create (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSpiQrCode'] to see the possible values for this operation
     *
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\SpiQrCodes|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\LomiLaravel\Model\SpiQrCodes';
        $request = $this->createSpiQrCodeRequest($spi_qr_codes_create, $contentType);
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\ListSpiAccountAliases200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\ListSpiAccountAliases200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listSpiAccountAliasesWithHttpInfo($limit = 20, $offset = 0, $sort = null, string $contentType = self::contentTypes['listSpiAccountAliases'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\LomiLaravel\Model\ListSpiAccountAliases200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\LomiLaravel\Model\ListSpiAccountAliases200Response';
        $request = $this->listSpiAccountAliasesRequest($limit, $offset, $sort, $contentType);
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\ListSpiQrCodes200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\ListSpiQrCodes200Response|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listSpiQrCodesWithHttpInfo($limit = 20, $offset = 0, $sort = null, string $contentType = self::contentTypes['listSpiQrCodes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\LomiLaravel\Model\ListSpiQrCodes200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\LomiLaravel\Model\ListSpiQrCodes200Response';
        $request = $this->listSpiQrCodesRequest($limit, $offset, $sort, $contentType);
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\SpiAccountAliases|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\SpiAccountAliases|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveSpiAccountAliaseWithHttpInfo($alias_id, string $contentType = self::contentTypes['retrieveSpiAccountAliase'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\LomiLaravel\Model\SpiAccountAliases',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\LomiLaravel\Model\SpiAccountAliases';
        $request = $this->retrieveSpiAccountAliaseRequest($alias_id, $contentType);
     ...
     *
     * @param  string $qr_code_id Unique identifier for the spi qr code (required)
     * @param  \LomiLaravel\Model\SpiQrCodesUpdate $spi_qr_codes_update spi_qr_codes_update (required)
     ...
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LomiLaravel\Model\SpiQrCodes|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error
     */
     ...
     *
     * @param  string $qr_code_id Unique identifier for the spi qr code (required)
     * @param  \LomiLaravel\Model\SpiQrCodesUpdate $spi_qr_codes_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSpiQrCode'] to see the possible values for this operation
     *
     * @throws \LomiLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LomiLaravel\Model\SpiQrCodes|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error|\LomiLaravel\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
