...
/**
 * DiscountCouponsUpdate Class Doc Comment
 *
 * @category Class
 * @description Request body for updating a discount coupons object. Only include fields you want to modify.
 * @package  LomiLaravel
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DiscountCouponsUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'discount_coupons_update';
