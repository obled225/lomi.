...
/**
 * CustomerInvoicesUpdate Class Doc Comment
 *
 * @category Class
 * @description Request body for updating a customer invoices object. Only include fields you want to modify.
 * @package  LomiLaravel
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomerInvoicesUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer_invoices_update';
