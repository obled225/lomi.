...
/**
 * PayoutsUpdate Class Doc Comment
 *
 * @category Class
 * @description Request body for updating a payouts object. Only include fields you want to modify.
 * @package  LomiLaravel
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PayoutsUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'payouts_update';
