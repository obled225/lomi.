...
/**
 * SpiQrCodesUpdate Class Doc Comment
 *
 * @category Class
 * @description Request body for updating a spi qr codes object. Only include fields you want to modify.
 * @package  LomiLaravel
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SpiQrCodesUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'spi_qr_codes_update';
