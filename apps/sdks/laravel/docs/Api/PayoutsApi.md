...
```php
createBeneficiaryPayout($beneficiary_payouts_create): \LomiLaravel\Model\BeneficiaryPayouts
```
...
$apiInstance = new LomiLaravel\Api\PayoutsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$beneficiary_payouts_create = {"name":"Sample beneficiary_payout","description":"Example beneficiary_payout object"}; // \LomiLaravel\Model\BeneficiaryPayoutsCreate
...
| ------------- | ------------- | ------------- | ------------- |
| **beneficiary_payouts_create** | [**\LomiLaravel\Model\BeneficiaryPayoutsCreate**](../Model/BeneficiaryPayoutsCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\BeneficiaryPayouts**](../Model/BeneficiaryPayouts.md)
...
```php
createPayout($payouts_create): \LomiLaravel\Model\Payouts
```
...
$payouts_create = {"amount":100000,"currency_code":"XOF","beneficiary_account_id":"acc_1234567890abcdef","description":"Monthly payout to vendor"}; // \LomiLaravel\Model\PayoutsCreate
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **payouts_create** | [**\LomiLaravel\Model\PayoutsCreate**](../Model/PayoutsCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\Payouts**](../Model/Payouts.md)
...
```php
listBeneficiaryPayouts($limit, $offset, $sort): \LomiLaravel\Model\ListBeneficiaryPayouts200Response
```
...
[**\LomiLaravel\Model\ListBeneficiaryPayouts200Response**](../Model/ListBeneficiaryPayouts200Response.md)
...
```php
listPayoutMethods($limit, $offset, $sort): \LomiLaravel\Model\ListPayoutMethods200Response
```
...
[**\LomiLaravel\Model\ListPayoutMethods200Response**](../Model/ListPayoutMethods200Response.md)
...
```php
listPayouts($limit, $offset, $sort): \LomiLaravel\Model\ListPayouts200Response
```
...
[**\LomiLaravel\Model\ListPayouts200Response**](../Model/ListPayouts200Response.md)
...
```php
retrieveBeneficiaryPayout($payout_id): \LomiLaravel\Model\BeneficiaryPayouts
```
...
```php
retrievePayout($payout_id): \LomiLaravel\Model\Payouts
```
...
```php
retrievePayoutMethod($payout_method_id): \LomiLaravel\Model\PayoutMethods
```
...
[**\LomiLaravel\Model\PayoutMethods**](../Model/PayoutMethods.md)
...
```php
updatePayout($payout_id, $payouts_update): \LomiLaravel\Model\Payouts
```
...
$payout_id = 'payout_id_example'; // string | Unique identifier for the payout
$payouts_update = {"metadata":{"updated_at":"2025-11-21T12:46:27.079Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\PayoutsUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **payout_id** | **string**| Unique identifier for the payout | |
| **payouts_update** | [**\LomiLaravel\Model\PayoutsUpdate**](../Model/PayoutsUpdate.md)|  | |
