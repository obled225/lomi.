...
$apiInstance = new LomiLaravel\Api\SPIApi(
...
```php
listSpiAccountAliases($limit, $offset, $sort): \LomiLaravel\Model\ListSpiAccountAliases200Response
```
...
[**\LomiLaravel\Model\ListSpiAccountAliases200Response**](../Model/ListSpiAccountAliases200Response.md)
...
```php
retrieveSpiAccountAliase($alias_id): \LomiLaravel\Model\SpiAccountAliases
```
...
[**\LomiLaravel\Model\SpiAccountAliases**](../Model/SpiAccountAliases.md)
...
$qr_code_id = 'qr_code_id_example'; // string | Unique identifier for the spi qr code
$spi_qr_codes_update = {"metadata":{"updated_at":"2025-11-21T12:46:27.079Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\SpiQrCodesUpdate
