...
```php
createCheckoutSession($checkout_sessions_create): \LomiLaravel\Model\CheckoutSessions
```
...
$apiInstance = new LomiLaravel\Api\CheckoutApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$checkout_sessions_create = {"amount":15000,"currency_code":"XOF","product_id":"prod_1234567890abcdef","success_url":"https://example.com/success","cancel_url":"https://example.com/cancel","customer_email":"customer@example.com"}; // \LomiLaravel\Model\CheckoutSessionsCreate
...
| ------------- | ------------- | ------------- | ------------- |
| **checkout_sessions_create** | [**\LomiLaravel\Model\CheckoutSessionsCreate**](../Model/CheckoutSessionsCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\CheckoutSessions**](../Model/CheckoutSessions.md)
...
```php
createPaymentLink($payment_links_create): \LomiLaravel\Model\PaymentLinks
```
...
$payment_links_create = {"title":"Premium Membership","amount":50000,"currency_code":"XOF","description":"Annual premium membership","product_id":"prod_1234567890abcdef"}; // \LomiLaravel\Model\PaymentLinksCreate
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **payment_links_create** | [**\LomiLaravel\Model\PaymentLinksCreate**](../Model/PaymentLinksCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\PaymentLinks**](../Model/PaymentLinks.md)
...
```php
listCheckoutSessions($limit, $offset, $sort): \LomiLaravel\Model\ListCheckoutSessions200Response
```
...
[**\LomiLaravel\Model\ListCheckoutSessions200Response**](../Model/ListCheckoutSessions200Response.md)
...
```php
listPaymentLinks($limit, $offset, $sort): \LomiLaravel\Model\ListPaymentLinks200Response
```
...
[**\LomiLaravel\Model\ListPaymentLinks200Response**](../Model/ListPaymentLinks200Response.md)
...
```php
retrieveCheckoutSession($session_id): \LomiLaravel\Model\CheckoutSessions
```
...
```php
retrievePaymentLink($link_id): \LomiLaravel\Model\PaymentLinks
```
...
```php
updateCheckoutSession($session_id, $checkout_sessions_update): \LomiLaravel\Model\CheckoutSessions
```
...
$session_id = 'session_id_example'; // string | Unique identifier for the checkout session
$checkout_sessions_update = {"metadata":{"updated_at":"2025-11-21T12:46:27.078Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\CheckoutSessionsUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **session_id** | **string**| Unique identifier for the checkout session | |
| **checkout_sessions_update** | [**\LomiLaravel\Model\CheckoutSessionsUpdate**](../Model/CheckoutSessionsUpdate.md)|  | |
...
```php
updatePaymentLink($link_id, $payment_links_update): \LomiLaravel\Model\PaymentLinks
```
...
$link_id = 'link_id_example'; // string | Unique identifier for the payment link
$payment_links_update = {"metadata":{"updated_at":"2025-11-21T12:46:27.079Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\PaymentLinksUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **link_id** | **string**| Unique identifier for the payment link | |
| **payment_links_update** | [**\LomiLaravel\Model\PaymentLinksUpdate**](../Model/PaymentLinksUpdate.md)|  | |
