...
```php
createDiscountCoupon($discount_coupons_create): \LomiLaravel\Model\DiscountCoupons
```
...
$apiInstance = new LomiLaravel\Api\SubscriptionsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$discount_coupons_create = {"code":"WELCOME2024","discount_type":"percentage","discount_percentage":20,"max_uses":100,"is_active":true,"expires_at":"2024-12-31T23:59:59Z","description":"Welcome discount for new customers"}; // \LomiLaravel\Model\DiscountCouponsCreate
...
| ------------- | ------------- | ------------- | ------------- |
| **discount_coupons_create** | [**\LomiLaravel\Model\DiscountCouponsCreate**](../Model/DiscountCouponsCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\DiscountCoupons**](../Model/DiscountCoupons.md)
...
```php
createSubscription($subscriptions_create): \LomiLaravel\Model\Subscriptions
```
...
$subscriptions_create = {"customer_id":"cus_1234567890abcdef","product_id":"prod_1234567890abcdef","price_id":"price_1234567890abcdef","billing_frequency":"monthly","metadata":{"plan":"premium"}}; // \LomiLaravel\Model\SubscriptionsCreate
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **subscriptions_create** | [**\LomiLaravel\Model\SubscriptionsCreate**](../Model/SubscriptionsCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\Subscriptions**](../Model/Subscriptions.md)
...
```php
listCustomerInvoices($limit, $offset, $sort): \LomiLaravel\Model\ListCustomerInvoices200Response
```
...
[**\LomiLaravel\Model\ListCustomerInvoices200Response**](../Model/ListCustomerInvoices200Response.md)
...
```php
listDiscountCoupons($limit, $offset, $sort): \LomiLaravel\Model\ListDiscountCoupons200Response
```
...
[**\LomiLaravel\Model\ListDiscountCoupons200Response**](../Model/ListDiscountCoupons200Response.md)
...
```php
listSubscriptions($limit, $offset, $sort): \LomiLaravel\Model\ListSubscriptions200Response
```
...
[**\LomiLaravel\Model\ListSubscriptions200Response**](../Model/ListSubscriptions200Response.md)
...
```php
retrieveCustomerInvoice($invoice_id): \LomiLaravel\Model\CustomerInvoices
```
...
[**\LomiLaravel\Model\CustomerInvoices**](../Model/CustomerInvoices.md)
...
```php
retrieveDiscountCoupon($coupon_id): \LomiLaravel\Model\DiscountCoupons
```
...
```php
retrieveSubscription($subscription_id): \LomiLaravel\Model\Subscriptions
```
...
```php
updateDiscountCoupon($coupon_id, $discount_coupons_update): \LomiLaravel\Model\DiscountCoupons
```
...
$coupon_id = 'coupon_id_example'; // string | Unique identifier for the discount coupon
$discount_coupons_update = {"is_active":false,"max_uses":50}; // \LomiLaravel\Model\DiscountCouponsUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **coupon_id** | **string**| Unique identifier for the discount coupon | |
| **discount_coupons_update** | [**\LomiLaravel\Model\DiscountCouponsUpdate**](../Model/DiscountCouponsUpdate.md)|  | |
...
```php
updateSubscription($subscription_id, $subscriptions_update): \LomiLaravel\Model\Subscriptions
```
...
$subscription_id = 'subscription_id_example'; // string | Unique identifier for the subscription
$subscriptions_update = {"metadata":{"plan":"enterprise","upgraded_at":"2025-11-21T12:46:27.078Z"}}; // \LomiLaravel\Model\SubscriptionsUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **subscription_id** | **string**| Unique identifier for the subscription | |
| **subscriptions_update** | [**\LomiLaravel\Model\SubscriptionsUpdate**](../Model/SubscriptionsUpdate.md)|  | |
