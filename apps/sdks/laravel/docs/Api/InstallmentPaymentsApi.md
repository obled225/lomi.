# LomiLaravel\InstallmentPaymentsApi
...
```php
listInstallmentPayments($limit, $offset, $sort): \LomiLaravel\Model\ListInstallmentPayments200Response
```
...
$apiInstance = new LomiLaravel\Api\InstallmentPaymentsApi(
...
[**\LomiLaravel\Model\ListInstallmentPayments200Response**](../Model/ListInstallmentPayments200Response.md)
...
```php
retrieveInstallmentPayment($payment_id): \LomiLaravel\Model\InstallmentPayments
```
...
[**\LomiLaravel\Model\InstallmentPayments**](../Model/InstallmentPayments.md)
