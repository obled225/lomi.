...
$apiInstance = new LomiLaravel\Api\MetersApi(
...
$meter_id = 'meter_id_example'; // string | Unique identifier for the meter
$meters_update = {"metadata":{"updated_at":"2025-11-21T13:32:16.241Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\MetersUpdate
