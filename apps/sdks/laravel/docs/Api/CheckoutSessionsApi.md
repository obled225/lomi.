# LomiLaravel\CheckoutSessionsApi
...
$apiInstance = new LomiLaravel\Api\CheckoutSessionsApi(
...
$session_id = 'session_id_example'; // string | Unique identifier for the checkout session
$checkout_sessions_update = {"metadata":{"updated_at":"2025-11-21T13:32:16.240Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\CheckoutSessionsUpdate
