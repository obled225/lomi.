...
```php
listEvents($limit, $offset, $sort): \LomiLaravel\Model\ListEvents200Response
```
...
$apiInstance = new LomiLaravel\Api\EventsApi(
...
[**\LomiLaravel\Model\ListEvents200Response**](../Model/ListEvents200Response.md)
...
```php
retrieveEvent($event_id): \LomiLaravel\Model\Events
```
...
[**\LomiLaravel\Model\Events**](../Model/Events.md)
