...
$apiInstance = new LomiLaravel\Api\RefundsApi(
...
$refund_id = 'refund_id_example'; // string | Unique identifier for the refund
$refunds_update = {"metadata":{"updated_at":"2025-11-21T13:32:16.239Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\RefundsUpdate
