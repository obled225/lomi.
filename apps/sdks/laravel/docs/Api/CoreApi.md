...
```php
createCustomer($customers_create): \LomiLaravel\Model\Customers
```
...
$apiInstance = new LomiLaravel\Api\CoreApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$customers_create = {"name":"Aminata Diallo","email":"aminata.diallo@example.com","phone_number":"+225021234567","metadata":{"customer_segment":"premium","referral_source":"instagram"}}; // \LomiLaravel\Model\CustomersCreate
...
| ------------- | ------------- | ------------- | ------------- |
| **customers_create** | [**\LomiLaravel\Model\CustomersCreate**](../Model/CustomersCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\Customers**](../Model/Customers.md)
...
```php
createPaymentRequest($payment_requests_create): \LomiLaravel\Model\PaymentRequests
```
...
$payment_requests_create = {"amount":25000,"currency_code":"XOF","customer_id":"cus_1234567890abcdef","description":"Payment for premium subscription","metadata":{"order_id":"ORD-2024-001"}}; // \LomiLaravel\Model\PaymentRequestsCreate
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **payment_requests_create** | [**\LomiLaravel\Model\PaymentRequestsCreate**](../Model/PaymentRequestsCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\PaymentRequests**](../Model/PaymentRequests.md)
...
```php
createRefund($refunds_create): \LomiLaravel\Model\Refunds
```
...
$refunds_create = {"name":"Sample refund","description":"Example refund object"}; // \LomiLaravel\Model\RefundsCreate
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **refunds_create** | [**\LomiLaravel\Model\RefundsCreate**](../Model/RefundsCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\Refunds**](../Model/Refunds.md)
...
```php
listCustomers($limit, $offset, $sort): \LomiLaravel\Model\ListCustomers200Response
```
...
[**\LomiLaravel\Model\ListCustomers200Response**](../Model/ListCustomers200Response.md)
...
```php
listPaymentRequests($limit, $offset, $sort): \LomiLaravel\Model\ListPaymentRequests200Response
```
...
[**\LomiLaravel\Model\ListPaymentRequests200Response**](../Model/ListPaymentRequests200Response.md)
...
```php
listRefunds($limit, $offset, $sort): \LomiLaravel\Model\ListRefunds200Response
```
...
[**\LomiLaravel\Model\ListRefunds200Response**](../Model/ListRefunds200Response.md)
...
```php
listTransactions($limit, $offset, $sort): \LomiLaravel\Model\ListTransactions200Response
```
...
[**\LomiLaravel\Model\ListTransactions200Response**](../Model/ListTransactions200Response.md)
...
```php
retrieveCustomer($customer_id): \LomiLaravel\Model\Customers
```
...
```php
retrievePaymentRequest($request_id): \LomiLaravel\Model\PaymentRequests
```
...
```php
retrieveRefund($refund_id): \LomiLaravel\Model\Refunds
```
...
```php
retrieveTransaction($transaction_id): \LomiLaravel\Model\Transactions
```
...
[**\LomiLaravel\Model\Transactions**](../Model/Transactions.md)
...
```php
updateCustomer($customer_id, $customers_update): \LomiLaravel\Model\Customers
```
...
$customer_id = 'customer_id_example'; // string | Unique identifier for the customer
$customers_update = {"name":"Aminata Diallo-Kane","phone_number":"+225779876543","metadata":{"customer_segment":"vip","notes":"Upgraded to VIP tier"}}; // \LomiLaravel\Model\CustomersUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **customer_id** | **string**| Unique identifier for the customer | |
| **customers_update** | [**\LomiLaravel\Model\CustomersUpdate**](../Model/CustomersUpdate.md)|  | |
...
```php
updatePaymentRequest($request_id, $payment_requests_update): \LomiLaravel\Model\PaymentRequests
```
...
$request_id = 'request_id_example'; // string | Unique identifier for the payment request
$payment_requests_update = {"metadata":{"order_id":"ORD-2024-001-UPDATED","notes":"Customer requested invoice"}}; // \LomiLaravel\Model\PaymentRequestsUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **request_id** | **string**| Unique identifier for the payment request | |
| **payment_requests_update** | [**\LomiLaravel\Model\PaymentRequestsUpdate**](../Model/PaymentRequestsUpdate.md)|  | |
...
```php
updateRefund($refund_id, $refunds_update): \LomiLaravel\Model\Refunds
```
...
$refund_id = 'refund_id_example'; // string | Unique identifier for the refund
$refunds_update = {"metadata":{"updated_at":"2025-11-21T12:46:27.077Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\RefundsUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **refund_id** | **string**| Unique identifier for the refund | |
| **refunds_update** | [**\LomiLaravel\Model\RefundsUpdate**](../Model/RefundsUpdate.md)|  | |
