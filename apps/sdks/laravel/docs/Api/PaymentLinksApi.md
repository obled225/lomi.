...
$apiInstance = new LomiLaravel\Api\PaymentLinksApi(
...
$link_id = 'link_id_example'; // string | Unique identifier for the payment link
$payment_links_update = {"metadata":{"updated_at":"2025-11-21T13:32:16.240Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\PaymentLinksUpdate
