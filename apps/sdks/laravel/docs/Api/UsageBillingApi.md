...
```php
createMeter($meters_create): \LomiLaravel\Model\Meters
```
...
$apiInstance = new LomiLaravel\Api\UsageBillingApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$meters_create = {"name":"Sample meter","description":"Example meter object"}; // \LomiLaravel\Model\MetersCreate
...
| ------------- | ------------- | ------------- | ------------- |
| **meters_create** | [**\LomiLaravel\Model\MetersCreate**](../Model/MetersCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\Meters**](../Model/Meters.md)
...
```php
listMeterBalances($limit, $offset, $sort): \LomiLaravel\Model\ListMeterBalances200Response
```
...
[**\LomiLaravel\Model\ListMeterBalances200Response**](../Model/ListMeterBalances200Response.md)
...
```php
listMeters($limit, $offset, $sort): \LomiLaravel\Model\ListMeters200Response
```
...
[**\LomiLaravel\Model\ListMeters200Response**](../Model/ListMeters200Response.md)
...
```php
retrieveMeter($meter_id): \LomiLaravel\Model\Meters
```
...
```php
retrieveMeterBalance($balance_id): \LomiLaravel\Model\MeterBalances
```
...
[**\LomiLaravel\Model\MeterBalances**](../Model/MeterBalances.md)
...
```php
updateMeter($meter_id, $meters_update): \LomiLaravel\Model\Meters
```
...
$meter_id = 'meter_id_example'; // string | Unique identifier for the meter
$meters_update = {"metadata":{"updated_at":"2025-11-21T12:46:27.080Z","updated_reason":"Administrative update"}}; // \LomiLaravel\Model\MetersUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **meter_id** | **string**| Unique identifier for the meter | |
| **meters_update** | [**\LomiLaravel\Model\MetersUpdate**](../Model/MetersUpdate.md)|  | |
