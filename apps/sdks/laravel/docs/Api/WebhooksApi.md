...
```php
createWebhook($webhooks_create): \LomiLaravel\Model\Webhooks
```
...
$apiInstance = new LomiLaravel\Api\WebhooksApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$webhooks_create = {"url":"https://api.example.com/webhooks/lomi","events":["payment.succeeded","payment.failed"],"description":"Production webhook endpoint","is_active":true}; // \LomiLaravel\Model\WebhooksCreate
...
| ------------- | ------------- | ------------- | ------------- |
| **webhooks_create** | [**\LomiLaravel\Model\WebhooksCreate**](../Model/WebhooksCreate.md)|  | |

### Return type

[**\LomiLaravel\Model\Webhooks**](../Model/Webhooks.md)
...
```php
listWebhookDeliveryLogs($limit, $offset, $sort): \LomiLaravel\Model\ListWebhookDeliveryLogs200Response
```
...
try {
    ...
    echo 'Exception when calling WebhooksApi->listWebhookDeliveryLogs: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\LomiLaravel\Model\ListWebhookDeliveryLogs200Response**](../Model/ListWebhookDeliveryLogs200Response.md)
...
```php
listWebhooks($limit, $offset, $sort): \LomiLaravel\Model\ListWebhooks200Response
```
...
[**\LomiLaravel\Model\ListWebhooks200Response**](../Model/ListWebhooks200Response.md)
...
```php
retrieveWebhook($webhook_id): \LomiLaravel\Model\Webhooks
```
...
```php
retrieveWebhookDeliveryLog($log_id): \LomiLaravel\Model\WebhookDeliveryLogs
```
...
try {
    ...
    echo 'Exception when calling WebhooksApi->retrieveWebhookDeliveryLog: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\LomiLaravel\Model\WebhookDeliveryLogs**](../Model/WebhookDeliveryLogs.md)
...
```php
updateWebhook($webhook_id, $webhooks_update): \LomiLaravel\Model\Webhooks
```
...
$webhook_id = 'webhook_id_example'; // string | Unique identifier for the webhook
$webhooks_update = {"is_active":false,"description":"Temporarily disabled for maintenance"}; // \LomiLaravel\Model\WebhooksUpdate
...
| ------------- | ------------- | ------------- | ------------- |
| **webhook_id** | **string**| Unique identifier for the webhook | |
| **webhooks_update** | [**\LomiLaravel\Model\WebhooksUpdate**](../Model/WebhooksUpdate.md)|  | |
