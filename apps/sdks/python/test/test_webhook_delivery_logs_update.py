...
class TestWebhookDeliveryLogsUpdate(unittest.TestCase):
    """WebhookDeliveryLogsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDeliveryLogsUpdate:
        """Test WebhookDeliveryLogsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDeliveryLogsUpdate`
        """
        model = WebhookDeliveryLogsUpdate()
        if include_optional:
            return WebhookDeliveryLogsUpdate(
    ...
    def testWebhookDeliveryLogsUpdate(self):
        """Test WebhookDeliveryLogsUpdate"""
