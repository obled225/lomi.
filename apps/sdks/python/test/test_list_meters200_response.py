...
class TestListMeters200Response(unittest.TestCase):
    """ListMeters200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMeters200Response:
        """Test ListMeters200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMeters200Response`
        """
        model = ListMeters200Response()
        if include_optional:
    ...
    def testListMeters200Response(self):
        """Test ListMeters200Response"""
