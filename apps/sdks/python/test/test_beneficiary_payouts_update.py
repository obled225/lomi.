...
class TestBeneficiaryPayoutsUpdate(unittest.TestCase):
    """BeneficiaryPayoutsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryPayoutsUpdate:
        """Test BeneficiaryPayoutsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryPayoutsUpdate`
        """
        model = BeneficiaryPayoutsUpdate()
        if include_optional:
            return BeneficiaryPayoutsUpdate(
                account_id = '',
                amount = 1.337,
    ...
    def testBeneficiaryPayoutsUpdate(self):
        """Test BeneficiaryPayoutsUpdate"""
