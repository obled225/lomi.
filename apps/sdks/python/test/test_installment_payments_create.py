...
class TestInstallmentPaymentsCreate(unittest.TestCase):
    """InstallmentPaymentsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstallmentPaymentsCreate:
        """Test InstallmentPaymentsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstallmentPaymentsCreate`
        """
        model = InstallmentPaymentsCreate()
        if include_optional:
            return InstallmentPaymentsCreate(
                amount = 1.337,
    ...
    def testInstallmentPaymentsCreate(self):
        """Test InstallmentPaymentsCreate"""
