...
class TestPaymentRequestsCreate(unittest.TestCase):
    """PaymentRequestsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentRequestsCreate:
        """Test PaymentRequestsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentRequestsCreate`
        """
        model = PaymentRequestsCreate()
        if include_optional:
    ...
    def testPaymentRequestsCreate(self):
        """Test PaymentRequestsCreate"""
