...
class TestRefundsCreate(unittest.TestCase):
    """RefundsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundsCreate:
        """Test RefundsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundsCreate`
        """
        model = RefundsCreate()
        if include_optional:
