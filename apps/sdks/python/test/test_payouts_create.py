...
class TestPayoutsCreate(unittest.TestCase):
    """PayoutsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutsCreate:
        """Test PayoutsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutsCreate`
        """
        model = PayoutsCreate()
        if include_optional:
