...
class TestCustomerInvoicesGet200Response(unittest.TestCase):
    """CustomerInvoicesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerInvoicesGet200Response:
        """Test CustomerInvoicesGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerInvoicesGet200Response`
        """
        model = CustomerInvoicesGet200Response()
        if include_optional:
    ...
    def testCustomerInvoicesGet200Response(self):
        """Test CustomerInvoicesGet200Response"""
