...
class TestCustomersGet200Response(unittest.TestCase):
    """CustomersGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomersGet200Response:
        ...
        # uncomment below to create an instance of `CustomersGet200Response`
        """
        model = CustomersGet200Response()
        if include_optional:
            return CustomersGet200Response(
                data = [
                    lomi_sdk.models.customers.customers(
                        address = '', 
                        city = '', 
                        country = '', 
