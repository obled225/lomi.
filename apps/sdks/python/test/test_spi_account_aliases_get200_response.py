...
class TestSpiAccountAliasesGet200Response(unittest.TestCase):
    """SpiAccountAliasesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpiAccountAliasesGet200Response:
        """Test SpiAccountAliasesGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpiAccountAliasesGet200Response`
        """
        model = SpiAccountAliasesGet200Response()
        if include_optional:
    ...
    def testSpiAccountAliasesGet200Response(self):
        """Test SpiAccountAliasesGet200Response"""
