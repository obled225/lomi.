...
class TestProductsUpdate(unittest.TestCase):
    """ProductsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductsUpdate:
        """Test ProductsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductsUpdate`
        """
        model = ProductsUpdate()
        if include_optional:
