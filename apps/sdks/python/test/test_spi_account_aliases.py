...
class TestSpiAccountAliases(unittest.TestCase):
    """SpiAccountAliases unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpiAccountAliases:
        """Test SpiAccountAliases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpiAccountAliases`
        """
        model = SpiAccountAliases()
        if include_optional:
    ...
    def testSpiAccountAliases(self):
        """Test SpiAccountAliases"""
