...
class TestPaymentLinksCreate(unittest.TestCase):
    """PaymentLinksCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentLinksCreate:
        """Test PaymentLinksCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentLinksCreate`
        """
        model = PaymentLinksCreate()
        if include_optional:
            return PaymentLinksCreate(
    ...
    def testPaymentLinksCreate(self):
        """Test PaymentLinksCreate"""
