...
class TestMeterBalancesCreate(unittest.TestCase):
    """MeterBalancesCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeterBalancesCreate:
        """Test MeterBalancesCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeterBalancesCreate`
        """
        model = MeterBalancesCreate()
        if include_optional:
            return MeterBalancesCreate(
                balance = 1.337,
                balance_id = '',
    ...
    def testMeterBalancesCreate(self):
        """Test MeterBalancesCreate"""
