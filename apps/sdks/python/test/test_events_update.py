...
class TestEventsUpdate(unittest.TestCase):
    """EventsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsUpdate:
        """Test EventsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsUpdate`
        """
        model = EventsUpdate()
        if include_optional:
            return EventsUpdate(
