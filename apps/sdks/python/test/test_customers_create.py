...
class TestCustomersCreate(unittest.TestCase):
    """CustomersCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomersCreate:
        """Test CustomersCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomersCreate`
        """
        model = CustomersCreate()
        if include_optional:
