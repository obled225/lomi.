...
class TestDiscountCouponsCreate(unittest.TestCase):
    """DiscountCouponsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscountCouponsCreate:
        """Test DiscountCouponsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscountCouponsCreate`
        """
        model = DiscountCouponsCreate()
        if include_optional:
            return DiscountCouponsCreate(
    ...
    def testDiscountCouponsCreate(self):
        """Test DiscountCouponsCreate"""
