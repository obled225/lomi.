...
class TestBeneficiaryPayoutsCreate(unittest.TestCase):
    """BeneficiaryPayoutsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryPayoutsCreate:
        """Test BeneficiaryPayoutsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryPayoutsCreate`
        """
        model = BeneficiaryPayoutsCreate()
        if include_optional:
            return BeneficiaryPayoutsCreate(
                account_id = '',
                amount = 1.337,
    ...
    def testBeneficiaryPayoutsCreate(self):
        """Test BeneficiaryPayoutsCreate"""
