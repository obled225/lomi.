...
class TestEventsCreate(unittest.TestCase):
    """EventsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsCreate:
        """Test EventsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsCreate`
        """
        model = EventsCreate()
        if include_optional:
            return EventsCreate(
