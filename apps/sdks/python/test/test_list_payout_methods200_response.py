...
class TestListPayoutMethods200Response(unittest.TestCase):
    """ListPayoutMethods200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPayoutMethods200Response:
        """Test ListPayoutMethods200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPayoutMethods200Response`
        """
        model = ListPayoutMethods200Response()
        if include_optional:
            return ListPayoutMethods200Response(
                data = [
                    lomi_sdk.models.payout_methods.payout_methods(
                        account_name = '', 
                        account_number = '', 
    ...
    def testListPayoutMethods200Response(self):
        """Test ListPayoutMethods200Response"""
