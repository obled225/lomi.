...
from lomi_sdk.api.subscription_api import SubscriptionApi
...
class TestSubscriptionApi(unittest.TestCase):
    ...
    def test_subscriptions_subscription_id_patch(self) -> None:
        """Test case for subscriptions_subscription_id_patch
