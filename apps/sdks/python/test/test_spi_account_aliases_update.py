...
class TestSpiAccountAliasesUpdate(unittest.TestCase):
    """SpiAccountAliasesUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpiAccountAliasesUpdate:
        """Test SpiAccountAliasesUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpiAccountAliasesUpdate`
        """
        model = SpiAccountAliasesUpdate()
        if include_optional:
            return SpiAccountAliasesUpdate(
                account_number = '',
                alias_id = '',
                alias_key = '',
                alias_type = '',
    ...
    def testSpiAccountAliasesUpdate(self):
        """Test SpiAccountAliasesUpdate"""
