...
from lomi_sdk.api.meter_api import MeterApi
...
class TestMeterApi(unittest.TestCase):
    ...
    def test_meters_meter_id_delete(self) -> None:
        """Test case for meters_meter_id_delete

        Delete meter
        """
        pass

    def test_meters_meter_id_get(self) -> None:
        """Test case for meters_meter_id_get

        Get meter
        """
        pass

    def test_meters_meter_id_patch(self) -> None:
        """Test case for meters_meter_id_patch

        Update meter
        """
        pass

    def test_meters_post(self) -> None:
        """Test case for meters_post
