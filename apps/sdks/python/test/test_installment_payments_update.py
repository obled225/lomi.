...
class TestInstallmentPaymentsUpdate(unittest.TestCase):
    """InstallmentPaymentsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstallmentPaymentsUpdate:
        """Test InstallmentPaymentsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstallmentPaymentsUpdate`
        """
        model = InstallmentPaymentsUpdate()
        if include_optional:
            return InstallmentPaymentsUpdate(
                amount = 1.337,
    ...
    def testInstallmentPaymentsUpdate(self):
        """Test InstallmentPaymentsUpdate"""
