...
class TestPricesCreate(unittest.TestCase):
    """PricesCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PricesCreate:
        """Test PricesCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PricesCreate`
        """
        model = PricesCreate()
        if include_optional:
            return PricesCreate(
