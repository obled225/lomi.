...
class TestListBeneficiaryPayouts200Response(unittest.TestCase):
    """ListBeneficiaryPayouts200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBeneficiaryPayouts200Response:
        """Test ListBeneficiaryPayouts200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBeneficiaryPayouts200Response`
        """
        model = ListBeneficiaryPayouts200Response()
        if include_optional:
            return ListBeneficiaryPayouts200Response(
                data = [
                    lomi_sdk.models.beneficiary_payouts.beneficiary_payouts(
                        account_id = '', 
                        amount = 1.337, 
    ...
    def testListBeneficiaryPayouts200Response(self):
        """Test ListBeneficiaryPayouts200Response"""
