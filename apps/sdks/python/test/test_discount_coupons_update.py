...
class TestDiscountCouponsUpdate(unittest.TestCase):
    """DiscountCouponsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscountCouponsUpdate:
        """Test DiscountCouponsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscountCouponsUpdate`
        """
        model = DiscountCouponsUpdate()
        if include_optional:
            return DiscountCouponsUpdate(
    ...
    def testDiscountCouponsUpdate(self):
        """Test DiscountCouponsUpdate"""
