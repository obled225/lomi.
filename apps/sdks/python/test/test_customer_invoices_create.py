...
class TestCustomerInvoicesCreate(unittest.TestCase):
    """CustomerInvoicesCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerInvoicesCreate:
        """Test customerInvoicesCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerInvoicesCreate`
        """
        model = CustomerInvoicesCreate()
        if include_optional:
            return CustomerInvoicesCreate(
                amount = 1.337,
    ...
    def testCustomerInvoicesCreate(self):
        """Test customerInvoicesCreate"""
