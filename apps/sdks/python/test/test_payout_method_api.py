...
from lomi_sdk.api.payout_method_api import PayoutMethodApi


class TestPayoutMethodApi(unittest.TestCase):
    """PayoutMethodApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PayoutMethodApi()

    def tearDown(self) -> None:
        pass

    def test_payout_methods_get(self) -> None:
        """Test case for payout_methods_get

        List payout_methods
        """
        pass

    def test_payout_methods_payout_method_id_get(self) -> None:
        """Test case for payout_methods_payout_method_id_get
