...
class TestListCustomers200ResponsePagination(unittest.TestCase):
    """ListCustomers200ResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCustomers200ResponsePagination:
        """Test ListCustomers200ResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCustomers200ResponsePagination`
        """
        model = ListCustomers200ResponsePagination()
        if include_optional:
            return ListCustomers200ResponsePagination(
                limit = 56,
                offset = 56,
                total = 56
            )
    ...
    def testListCustomers200ResponsePagination(self):
        """Test ListCustomers200ResponsePagination"""
