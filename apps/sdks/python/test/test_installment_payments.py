...
class TestInstallmentPayments(unittest.TestCase):
    """InstallmentPayments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstallmentPayments:
        """Test InstallmentPayments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstallmentPayments`
        """
    ...
    def testInstallmentPayments(self):
        """Test InstallmentPayments"""
