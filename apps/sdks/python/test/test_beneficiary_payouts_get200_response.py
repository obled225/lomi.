...
class TestBeneficiaryPayoutsGet200Response(unittest.TestCase):
    """BeneficiaryPayoutsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryPayoutsGet200Response:
        """Test BeneficiaryPayoutsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryPayoutsGet200Response`
        """
        model = BeneficiaryPayoutsGet200Response()
        if include_optional:
    ...
    def testBeneficiaryPayoutsGet200Response(self):
        """Test BeneficiaryPayoutsGet200Response"""
