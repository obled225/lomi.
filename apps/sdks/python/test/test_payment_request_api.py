...
from lomi_sdk.api.payment_request_api import PaymentRequestApi
...
class TestPaymentRequestApi(unittest.TestCase):
    ...
    def test_payment_requests_get(self) -> None:
        """Test case for payment_requests_get

        List payment_requests
        """
        pass

    def test_payment_requests_post(self) -> None:
        """Test case for payment_requests_post

        Create payment_request
        """
        pass

    def test_payment_requests_request_id_delete(self) -> None:
        """Test case for payment_requests_request_id_delete

        Delete payment_request
        """
        pass

    def test_payment_requests_request_id_get(self) -> None:
        """Test case for payment_requests_request_id_get

        Get payment_request
        """
        pass

    def test_payment_requests_request_id_patch(self) -> None:
        """Test case for payment_requests_request_id_patch
