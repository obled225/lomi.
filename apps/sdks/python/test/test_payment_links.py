...
class TestPaymentLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentLinks:
        """Test PaymentLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentLinks`
        """
        model = PaymentLinks()
        if include_optional:
            return PaymentLinks(
