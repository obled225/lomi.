...
class TestSpiAccountAliasesCreate(unittest.TestCase):
    """SpiAccountAliasesCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpiAccountAliasesCreate:
        """Test SpiAccountAliasesCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpiAccountAliasesCreate`
        """
        model = SpiAccountAliasesCreate()
        if include_optional:
            return SpiAccountAliasesCreate(
                account_number = '',
                alias_id = '',
                alias_key = '',
                alias_type = '',
    ...
    def testSpiAccountAliasesCreate(self):
        """Test SpiAccountAliasesCreate"""
