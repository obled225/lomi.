...
class TestRefundsGet200Response(unittest.TestCase):
    """RefundsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundsGet200Response:
        """Test RefundsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundsGet200Response`
        """
        model = RefundsGet200Response()
        if include_optional:
    ...
    def testRefundsGet200Response(self):
        """Test RefundsGet200Response"""
