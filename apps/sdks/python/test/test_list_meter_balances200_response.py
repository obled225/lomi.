...
class TestListMeterBalances200Response(unittest.TestCase):
    """ListMeterBalances200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMeterBalances200Response:
        """Test ListMeterBalances200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMeterBalances200Response`
        """
        model = ListMeterBalances200Response()
        if include_optional:
            return ListMeterBalances200Response(
                data = [
                    lomi_sdk.models.meter_balances.meter_balances(
                        balance = 1.337, 
                        balance_id = '', 
    ...
    def testListMeterBalances200Response(self):
        """Test ListMeterBalances200Response"""
