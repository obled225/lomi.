...
class TestTransactionsGet200Response(unittest.TestCase):
    """TransactionsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionsGet200Response:
        """Test TransactionsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionsGet200Response`
        """
        model = TransactionsGet200Response()
        if include_optional:
            return TransactionsGet200Response(
                data = [
                    lomi_sdk.models.transactions.transactions(
                        checkout_session_id = '', 
    ...
    def testTransactionsGet200Response(self):
        """Test TransactionsGet200Response"""
