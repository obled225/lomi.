...
class TestMetersCreate(unittest.TestCase):
    """MetersCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetersCreate:
        """Test MetersCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetersCreate`
        """
        model = MetersCreate()
        if include_optional:
            return MetersCreate(
