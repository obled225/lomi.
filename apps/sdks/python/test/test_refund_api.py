...
from lomi_sdk.api.refund_api import RefundApi
...
class TestRefundApi(unittest.TestCase):
    ...
    def test_refunds_post(self) -> None:
        """Test case for refunds_post

        Create refund
        """
        pass

    def test_refunds_refund_id_delete(self) -> None:
        """Test case for refunds_refund_id_delete
    ...
    def test_refunds_refund_id_patch(self) -> None:
        """Test case for refunds_refund_id_patch
