...
class TestCheckoutSessions(unittest.TestCase):
    """CheckoutSessions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutSessions:
        """Test CheckoutSessions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckoutSessions`
        """
