...
class TestCustomersUpdate(unittest.TestCase):
    """CustomersUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomersUpdate:
        """Test CustomersUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomersUpdate`
        """
        model = CustomersUpdate()
        if include_optional:
