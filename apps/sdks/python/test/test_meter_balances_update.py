...
class TestMeterBalancesUpdate(unittest.TestCase):
    """MeterBalancesUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeterBalancesUpdate:
        """Test MeterBalancesUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeterBalancesUpdate`
        """
        model = MeterBalancesUpdate()
        if include_optional:
            return MeterBalancesUpdate(
                balance = 1.337,
                balance_id = '',
    ...
    def testMeterBalancesUpdate(self):
        """Test MeterBalancesUpdate"""
