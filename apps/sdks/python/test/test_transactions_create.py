...
class TestTransactionsCreate(unittest.TestCase):
    """TransactionsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionsCreate:
        """Test TransactionsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionsCreate`
        """
        model = TransactionsCreate()
        if include_optional:
    ...
    def testTransactionsCreate(self):
        """Test TransactionsCreate"""
