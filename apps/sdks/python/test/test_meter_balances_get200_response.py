...
class TestMeterBalancesGet200Response(unittest.TestCase):
    """MeterBalancesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeterBalancesGet200Response:
        """Test MeterBalancesGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeterBalancesGet200Response`
        """
        model = MeterBalancesGet200Response()
        if include_optional:
    ...
    def testMeterBalancesGet200Response(self):
        """Test MeterBalancesGet200Response"""
