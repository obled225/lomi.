...
class TestPricesUpdate(unittest.TestCase):
    """PricesUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PricesUpdate:
        """Test PricesUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PricesUpdate`
        """
        model = PricesUpdate()
        if include_optional:
            return PricesUpdate(
