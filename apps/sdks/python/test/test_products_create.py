...
class TestProductsCreate(unittest.TestCase):
    """ProductsCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductsCreate:
        """Test ProductsCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductsCreate`
        """
        model = ProductsCreate()
        if include_optional:
