...
class TestListWebhookDeliveryLogs200Response(unittest.TestCase):
    """ListWebhookDeliveryLogs200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListWebhookDeliveryLogs200Response:
        """Test ListWebhookDeliveryLogs200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWebhookDeliveryLogs200Response`
        """
        model = ListWebhookDeliveryLogs200Response()
        if include_optional:
            return ListWebhookDeliveryLogs200Response(
                data = [
                    lomi_sdk.models.webhook_delivery_logs.webhook_delivery_logs(
                        attempt_number = 1.337, 
                        compte_paye = '', 
                        compte_payeur = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        event_type = '', 
                        headers = lomi_sdk.models.headers.headers(), 
                        ip_address = '', 
                        log_id = '', 
                        montant = 1.337, 
                        organization_id = '', 
                        payload = lomi_sdk.models.payload.payload(), 
    ...
    def testListWebhookDeliveryLogs200Response(self):
        """Test ListWebhookDeliveryLogs200Response"""
