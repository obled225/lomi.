...
class TestSpiQrCodesCreate(unittest.TestCase):
    """SpiQrCodesCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpiQrCodesCreate:
        """Test SpiQrCodesCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpiQrCodesCreate`
        """
        model = SpiQrCodesCreate()
        if include_optional:
            return SpiQrCodesCreate(
                categorie = '',
                checkout_session_id = '',
                compte_paye = '',
