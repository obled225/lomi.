...
class TestSpiQrCodes(unittest.TestCase):
    """SpiQrCodes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpiQrCodes:
        """Test SpiQrCodes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpiQrCodes`
        """
        model = SpiQrCodes()
        if include_optional:
            return SpiQrCodes(
