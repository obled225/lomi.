...
from lomi_sdk.configuration import Configuration
from lomi_sdk.api_response import ApiResponse, T as ApiResponseT
import lomi_sdk.models
from lomi_sdk import rest
from lomi_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(lomi_sdk.models, klass)
