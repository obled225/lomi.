...
class SubscriptionsApi:
    ...
    def list_customer_invoices(
        ...
        _param = self._list_customer_invoices_serialize(
            limit=limit,
            offset=offset,
            sort=sort,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListCustomerInvoices200Response",
            '401': "Error",
            '500': "Error",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def list_customer_invoices_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of items to return (1-100)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of items to skip for pagination")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort order. Format: `field:direction` (e.g., `created_at:desc`)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListCustomerInvoices200Response]:
        """List customer invoices
    ...
    @validate_call
    def list_customer_invoices_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of items to return (1-100)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of items to skip for pagination")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort order. Format: `field:direction` (e.g., `created_at:desc`)")] = None,
    ...
    def _list_customer_invoices_serialize(
        self,
        limit,
        offset,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/customer_invoices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def retrieve_customer_invoice(
        self,
        invoice_id: Annotated[UUID, Field(description="Unique identifier for the customer invoice")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param invoice_id: Unique identifier for the customer invoice (required)
        :type invoice_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._retrieve_customer_invoice_serialize(
    ...
    @validate_call
    def retrieve_customer_invoice_with_http_info(
        self,
        invoice_id: Annotated[UUID, Field(description="Unique identifier for the customer invoice")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retrieve_customer_invoice_without_preload_content(
        self,
        invoice_id: Annotated[UUID, Field(description="Unique identifier for the customer invoice")],
        _request_timeout: Union[
            None,
    ...
    def _retrieve_customer_invoice_serialize(
        self,
        invoice_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/customer_invoices/{invoice_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
