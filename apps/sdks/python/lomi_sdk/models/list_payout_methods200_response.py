...
class ListPayoutMethods200Response(BaseModel):
    """
    ListPayoutMethods200Response
    """ # noqa: E501
    data: Optional[List[PayoutMethods]] = None
    pagination: Optional[ListCustomers200ResponsePagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PayoutMethods.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pagination": ListCustomers200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
