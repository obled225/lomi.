...
class InstallmentPaymentsGet200Response(BaseModel):
    """
    InstallmentPaymentsGet200Response
    """ # noqa: E501
    data: Optional[List[InstallmentPayments]] = None
    pagination: Optional[CustomersGet200ResponsePagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": CustomersGet200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
