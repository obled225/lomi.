...
class TransactionsGet200Response(BaseModel):
    """
    TransactionsGet200Response
    """ # noqa: E501
    data: Optional[List[Transactions]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Transactions.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
