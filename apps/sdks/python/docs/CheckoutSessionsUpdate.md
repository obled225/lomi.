...
json = "{}"
# create an instance of CheckoutSessionsUpdate from a JSON string
checkout_sessions_update_instance = CheckoutSessionsUpdate.from_json(json)
# print the JSON string representation of the object
print(CheckoutSessionsUpdate.to_json())

# convert the object into a dict
checkout_sessions_update_dict = checkout_sessions_update_instance.to_dict()
# create an instance of CheckoutSessionsUpdate from a dict
checkout_sessions_update_from_dict = CheckoutSessionsUpdate.from_dict(checkout_sessions_update_dict)
```
