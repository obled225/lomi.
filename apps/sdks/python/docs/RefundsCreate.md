...
refunds_create_instance = RefundsCreate.from_json(json)
# print the JSON string representation of the object
print(RefundsCreate.to_json())

# convert the object into a dict
refunds_create_dict = refunds_create_instance.to_dict()
# create an instance of RefundsCreate from a dict
refunds_create_from_dict = RefundsCreate.from_dict(refunds_create_dict)
```
